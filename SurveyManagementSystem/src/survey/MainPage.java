...
public class MainPage implements Serializable { 
	...
	public void mainPageView(int id) throws SQLException {
		...
		addPanel.setBackground(Color.BLACK); // Set background color
		
		JLabel question = new JLabel("Question : ");
		question.setBounds(50, 100, 100, 20);
		question.setForeground(Color.WHITE); // Set text color
		...
		option1.setForeground(Color.WHITE); // Set text color
		...
		option2.setForeground(Color.WHITE); // Set text color
		...
		option3.setForeground(Color.WHITE); // Set text color
		...
		option4.setForeground(Color.WHITE); // Set text color
		...
		start.setForeground(Color.WHITE); // Set text color
		addPanel.add(start);
		
		JButton next = new JButton("ADD QUESTION >");
		next.setBounds(50, 440, 450, 35);
		next.setBackground(Color.WHITE); // Set button background color
		next.setForeground(Color.BLACK); // Set button text color
		addPanel.add(next);
		...
		submit.setBackground(Color.WHITE); // Set button background color
		submit.setForeground(Color.BLACK); // Set button text color
		addPanel.add(submit);
		...
		viewPanel.setBackground(Color.BLACK); // Set background color
		JLabel searchLabel = new JLabel("Search : ");
		searchLabel.setBounds(100, 20, 100, 50);
		searchLabel.setForeground(Color.WHITE); // Set text color
		...
		optionPanel.setBackground(new Color(135, 206, 235)); // Set background color to sky blue
